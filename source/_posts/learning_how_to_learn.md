...
这门课视频内容大概10小时，值得花时间去上，但是如果你想节省时间，可以直接看看本文（如果你觉得总结的不好，可以直接拿论据丢到评论区贴脸怼我（但拜托轻一点
...
因此可以看出来，这两种思维区别很大，而且不能同时应用，所以我们需要将两种思维模式结合使用，灵活转换。*专注模式更适合解决细节问题，发散模式更适合寻找灵感和整体解决方案*。
...
学习，其实就是掌握知识的过程，掌握的唯一体现，就是理解和记忆。
...
|  :--:  | :--:  |
| 短期记忆 | 长期记忆 |
| 负责处理即时的有意识的想法<br />例如学习新知识<br />如果不加以复习和记忆，会被其他信息挤掉 | 负责存储已掌握的知识<br />需要时常复习，才能提升未来能记忆到的几率 |
...
因此，**学习的本质，就是将知识从工作记忆，转化到长期记忆**。

而这个过程，需要的是**练习**.



那么怎样*在相同练习次数下，获取更牢固的记忆呢*？
